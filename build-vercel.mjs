// build-vercel.mjs - Inject API base URL for Vercel deployment (ES Module)
import fs from 'fs';
...
const API_BASE = process.env.API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE || 'https://your-backend.onrender.com/api';
